...
// BatchV1Client is used to interact with features provided by the batch.nanto.io group.
type BatchV1Client struct {
	restClient rest.Interface
}

func (c *BatchV1Client) ForecastTasks(namespace string) ForecastTaskInterface {
	return newForecastTasks(c, namespace)
}
